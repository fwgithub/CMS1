...
define('WEBURL','http://192.168.1.119/wuzhicms/www/');//网站域名
...
define('ATTACHMENT_URL','http://192.168.1.119/wuzhicms/www/uploadfile/');//附件路径
define('R','http://192.168.1.119/wuzhicms/www/res/');//静态文件存储目录
