...
<div class="web_meun">
    <div class="meun_mid">
        ...
        <a href="/index.php" target="_blank">武圣官网</a>
        <a href="index.php?m=member&f=index&v=account_safe" target="_blank">用户中心</a>
            ...
            <div class="webcont_top">
                ...
                <div class="left_login">
                    <div class="login_cont">
                        <h3>欢迎进入武圣客服中心</h3>
                        <p>亲爱的玩家</p>
                        <div id="mylogin" class="topnav_left"><a href="<?php echo WEBURL;?>index.php?m=member&v=login">登录</a>&nbsp;&nbsp;<span class="font_size10 color_999">|</span>&nbsp;&nbsp;<a href="<?php echo WEBURL;?>index.php?m=member&v=register">注册</a></div>
                        ...
                        <!--<?php if($_SESSION['uid']) { echo 'test';} else{ echo '';} ?>-->
