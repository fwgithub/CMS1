...
<div class="memberleftmenu">
    ...
    <ul>
        ...
        <li class="<?php if(M=='issue' && F=='myissue' && V=='listing') { ?>menuactive<?php } ?>"><a href="?m=guestbook&f=myissue&v=listing">我的建议</a></li>
        <li class="<?php if(M=='issue' && F=='myissue' && V=='listing') { ?>logintime<?php } ?>"><a href="?m=guestbook&f=myissue&v=logintime">我的登录记录</a></li>
    </ul>
    <div class="menutitle text-center"><i class="accounticon"></i>账户中心</div>
    <ul>
        <li class="<?php if(M=='member' && F=='index' && V=='profile') { ?>menuactive<?php } ?>"><a href="index.php?m=member&f=index&v=profile&acbar=2">账户信息</a></li>
