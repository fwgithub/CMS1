         ...
         <div class="head_meun head_on">
             <div class="head_meunb ">
              <a href="" target="_self">举报信息</a>
               <div class="head_li">
                <div class="btn_jb"><a href="index.php?v=listing&cid=55&page=1" target="_self">举报不良信息</a></div>
                <div class="btn_wg"><a href="index.php?v=listing&cid=56&page=1" target="_self">举报外挂</a></div>
              </div>
            </div>
        </div>
         <div class="head_meun">
...
<div class="more_cont">
       <div class="act_head">
            <img src="<?php echo R;?>t2/image/jubao.png" width="72" title="举报信息"/>
            <span>举报信息</span>
      ...
      <div class="cont_jbwg">
      <div class="jbxx_head">
                <a href="index.php?v=listing&cid=55&page=1"  style="margin-left:60px;">举报不良信息</a>
                <a href="index.php?v=listing&cid=56&page=1" class="jbhead_on">举报外挂</a>
              </div>
          <form class="form-horizontal"  name="myform" action="?m=guestbook&f=myissue&v=jbwg" method="post" enctype="multipart/form-data">
              <div class="form_li">
                  ...
                  <div class="form_input">
                    <input type="text" placeholder="被举报的玩家名" class="wjm" name="wjm" maxlength="15"/>
                      <input type="text" name="type"  style="display:none;" value="5"/>
                  </div>      
               </div>    
                 ...
                 <div class="form_li">
                  ...
                  <div class="form_input">
                    <textarea name="jbtxt" class="jb_box" maxlength="250" minlength="5" ></textarea>
                     ...
                     <input type="submit" value="提交" class="small_btn1" onclick="return check(this.form)"/>
           </form>
