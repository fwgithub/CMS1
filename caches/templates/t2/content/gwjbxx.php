         ...
         <div class="head_meun head_on">
             <div class="head_meunb ">
              <a href="" target="_self">举报信息</a>
               <div class="head_li">
                <div class="btn_jb"><a href="#" target="_self">举报不良信息</a></div>
                <div class="btn_wg"><a href="#" target="_self">举报外挂</a></div>
              </div>
            </div>
        </div>
         <div class="head_meun">
    ...
    <div class="jb_mid">
        <div class="more_cont">
          ...
          <div class="tishi_cont">
            ...
            <div class="cont_jbxx">
              <div class="jbxx_head">
                <a href="index.php?v=listing&cid=55&page=1" class="jbhead_on" style="margin-left:60px;">举报不良信息</a>
                <a href="index.php?v=listing&cid=56&page=1">举报外挂</a>
              </div>
                <form class="form-horizontal"  name="myform" action="?m=guestbook&f=myissue&v=jbxx" method="post" enctype="multipart/form-data">
              <div class="form_li">
