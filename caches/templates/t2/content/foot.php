...
if (method_exists($content_template_parse, 'category')) {
    ...
    <div style="text-align: center; padding-top:10px;font-size:12px; color:#7D7D7D"><?php echo $siteconfigs['copyright'];?><?php echo $siteconfigs['statcode'];?> Powered by <a href="http://www.wuzhicms.com" target="_blank">CMS</a> </div>-->
</div>
