...
<script type="text/javascript">
  ...
  <div class="more_cont">
  <div class="act_head">
            <img src="<?php echo R;?>t2/image/wenti.png" width="72" title="问题专区"/>
            <span>问题专区</span>
      ...
      <div class="cont_form">
          <form class="form-horizontal"  name="myform" action="?m=guestbook&f=myissue&v=wenti" method="post" enctype="multipart/form-data">
         <div class="form_li">
